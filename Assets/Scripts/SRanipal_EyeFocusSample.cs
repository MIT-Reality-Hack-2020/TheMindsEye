...
namespace ViveSR.anipal.Eye
{
    public class SRanipal_EyeFocusSample : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                Ray GazeRay;
                int dart_board_layer_id = 0;//LayerMask.NameToLayer("NoReflection");
                bool eye_focus;
                //eye_focus = SRanipal_Eye.Focus(index, out GazeRay, out FocusInfo, 0, MaxDistance, 0/*(1 << dart_board_layer_id)*/, eyeData);
                ...
                if (eye_focus)
                {
                    ...
                    */
                    ...
                    Focusable focusable = FocusInfo.transform.GetComponent<Focusable>();
                    if (focusable != null) focusable.Focus(FocusInfo.point);
                    break;
